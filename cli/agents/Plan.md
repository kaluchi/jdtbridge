...
```
jdt q '"<FQMN>" | @source'              # source text of type/method/field
jdt q '"<FQN>" | @members | table'      # class overview without reading 600 lines
jdt q '"<FQMN>" | @callers'             # who calls this method
jdt q '"<FQMN>" | @calls'               # what this method invokes
jdt q '"<FQMN>" | @implementors'        # implementations of an interface method
